...
[![Tests](https://github.com/otterscale/apps-operator/actions/workflows/test.yml/badge.svg)](https://github.com/otterscale/apps-operator/actions/workflows/test.yml)
[![Lint](https://github.com/otterscale/apps-operator/actions/workflows/lint.yml/badge.svg)](https://github.com/otterscale/apps-operator/actions/workflows/lint.yml)
[![codecov](https://codecov.io/gh/otterscale/apps-operator/branch/main/graph/badge.svg)](https://codecov.io/gh/otterscale/apps-operator)
[![Go Report Card](https://goreportcard.com/badge/github.com/otterscale/apps-operator)](https://goreportcard.com/report/github.com/otterscale/apps-operator)
[![Release](https://img.shields.io/github/v/release/otterscale/apps-operator)](https://github.com/otterscale/apps-operator/releases/latest)
[![License](https://img.shields.io/github/license/otterscale/apps-operator)](LICENSE)
